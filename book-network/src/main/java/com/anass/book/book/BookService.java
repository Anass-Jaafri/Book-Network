...
import com.anass.book.common.PageResponse;
import com.anass.book.exception.OperationNotPermittedException;
import com.anass.book.file.FileStorageService;
import com.anass.book.history.BookTransactionHistory;
import com.anass.book.history.BookTransactionHistoryRepository;
...
import static com.anass.book.book.BookSpecification.withOwnerId;
    ...
    public Integer approveReturnBorrowedBook(Integer bookId, Authentication connectedUser) {
        ...
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException(
                    "The requested book is archived or not shareable");
        }
        User user = ((User) connectedUser.getPrincipal());
        if (!Objects.equals(book.getOwner().getId(), user.getId())) {
            throw new OperationNotPermittedException(
